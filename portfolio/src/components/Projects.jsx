...
export default function Projects() {
  ...
  return (
    <div
      className='flex items-center flex-col gap-8 justify-center py-16'
      id='projects'>
      <div className='text-white font-poppins flex items-center flex-col gap-8 w-[90%]'>
        ...
        <p className='font-poppins text-secondary text-center w-full lg:text-left lg:text-4xl text-3xl'>
